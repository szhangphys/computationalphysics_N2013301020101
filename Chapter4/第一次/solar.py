...
class solar:
    def __init__(self, beta = 3.0, end = 5,  Gms = 4*pi , k=1.0,pos_1 =array([1.,0.,0.]), pos_2 = array([-1.,0.,0.]), v_1 = array([0.,1.,0.]), v_2 = array([0.,-0.001,0.]), dt = .0001 ):
        self.m_1 = Gms
        self.m_2 = k*Gms
        self.beta = beta
        self.n = int(end / dt)
